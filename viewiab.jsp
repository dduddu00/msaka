    ...
    <div class="board_wrap">
        <div class="board_view_wrap">
            <div class="board_view">
                ...
                <div class="cont">
                    안녕하다 나는 HAPPYDRAW 운영진 Park Sung Ho<br><br>
                    나, Korea 돌아온지 얼마 아니다 not yet, 서툴다<br><br>
                    기다리고 기다리던 추첨<br><br>
                    하지만 True, Randomly selected by Computer 공정 돌렸다<br><br>
                    IAB 응모 이벤트에 응모해주셔서<br><br>
                    너무나도 감사하다!<br><br>
                    당첨자는<br><br>
                    '호키' 이다!<br><br>
                    배송지 바랍니다 입력
                    ...
                    배송지를 잘못 입력한다<br><br>
                    Also, 사회로 환원된다<br></h3>
                    한국어를 도와준 My Team, HAPPYDRAW 에게도 감사하다<br>
