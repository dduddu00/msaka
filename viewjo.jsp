    ...
    <div class="board_wrap">
        <div class="board_view_wrap">
            <div class="board_view">
                ...
                <div class="cont">
                    안녕하세요, HappyDraw 입니다.<br><br>
                    이번 에어조던 미드 다크 틸 이벤트에 응모해주셔서 감사합니다. <br><br>
                    당첨자는 김조던 님입니다. <br><br>
                    응모 시 기재하신 배송지로 상품을 보내드리겠습니다.<br><br>
                    앞으로도 다양한 상품으로 이벤트를 진행할 예정이니 많은 관심 부탁드립니다.<br><br>
                    이번에 당첨되지 못하신 분들은 다음 기회를 노려보시기 바랍니다.<br><br>
                    감사합니다.
                </div>
            </div>
            <div class="bt_wrap">
