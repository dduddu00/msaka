	...
	<header class="bg-dark py-5">
		<div class="container px-4 px-lg-5 my-5">
			<div class="text-center text-white">
				<h1 class="display-4 fw-bolder">카카오클라우드 스쿨</h1>
				<p class="lead fw-normal text-white-50 mb-0">성호, 강인, 진영, 경서, 수연</p>
			</div>
		</div>
	</header>
			...
			<div
				...
				<div class="col mb-5">
					<div class="card h-100">
						...
						<!-- Product image-->
						<img class="card-img-top" src="./resources/Image/clo1.jpg"
							width="450" height="300" alt="보들보들 수면조끼" />
						<!-- Product details-->
						<div class="card-body p-4">
							<div class="text-center">
								<!-- Product name-->
								<h5 class="fw-bolder">보들보들 수면조끼</h5>
								<!-- Product reviews-->
								<div
				...
				<div class="col mb-5">
					<div class="card h-100">
						...
						<div class="badge bg-primary text-white position-absolute"
							style="top: 0.5rem; right: 0.5rem">Sale</div>
						<!-- Product image-->
						<img class="card-img-top" src="./resources/Image/bob.jpg"
							width="450" height="300" alt="..." />
						<!-- Product details-->
						<div class="card-body p-4">
							<div class="text-center">
								<!-- Product name-->
								<h5 class="fw-bolder">로얄캐닌 유리너리 S/O 스몰독 4kg</h5>
								<!-- Product price-->
								<span class="text-muted text-decoration-line-through">응모 기간 3/1 ~ 3/13
									</span> 연장 
							</div>
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<a class="btn btn-outline-dark mt-auto" href="bob.jsp">응모하기</a>
							</div>
						</div>
					</div>
				</div>
				<div class="col mb-5">
					<div class="card h-100">
						<!-- Product image-->
						<img class="card-img-top" src="./resources/Image/snk1.png"
							width="450" height="300" alt="펫슐랭" />
						<!-- Product details-->
						<div class="card-body p-4">
							<div class="text-center">
								<!-- Product name-->
								<h5 class="fw-bolder">펫슐랭 덴탈 바게트 강아지껌 200g - 관절&체중</h5>
								<!-- Product price-->
								응모 기간 3/1 ~ 3/13
							</div>
						</div>
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<a class="btn btn-outline-dark mt-auto" href="den.jsp">응모하기</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col mb-5">
					<div class="card h-100">
						<!-- Product image-->
						<img class="card-img-top" src="./resources/Image/clo2.jpg"
							width="450" height="300" alt="카키 야상" />
						<!-- Product details-->
						<div class="card-body p-4">
							<div class="text-center">
								<!-- Product name-->
								<h5 class="fw-bolder">카키 야상</h5>
								<!-- Product reviews-->
								<div
									class="d-flex justify-content-center small text-warning mb-2">
									<div class="bi-star-fill"></div>
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<a class="btn btn-outline-dark mt-auto" href="kaki.jsp">응모하기</a>
							</div>
						</div>
					</div>
				</div>
